...
exports.editTrosak = exports.addTrosak = void 0;
var database = require("../config/db.js");
function addTrosak(noviTrosak, response) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, database("dogadjaj_troskovi")
                            .insert(noviTrosak)];
                case 1:
                    insertedIds = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Greška prilikom dodavanja troška:', error_1);
...
exports.addTrosak = addTrosak;
function editTrosak(updatePodaciTroska, response) {
    return __awaiter(this, void 0, void 0, function () {
        var dogadjaj, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Greška prilikom izmene troška:', error_2);
