...
exports.editZadatak = exports.addZadatak = exports.getZadaci = void 0;
var database = require("../config/db.js");
function getZadaci(dogadjaj_id, callback) {
...
exports.getZadaci = getZadaci;
function addZadatak(noviZadatak, response) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    tmp = noviZadatak.datum_kreiranja.split(".");
                    noviZadatak.datum_kreiranja = tmp[2] + "-" + tmp[1] + "-" + tmp[0];
                    return [4 /*yield*/, database("dogadjaji_zadaci")
                            .insert(noviZadatak)];
                case 1:
                    insertedIds = _a.sent();
...
exports.addZadatak = addZadatak;
function editZadatak(updatePodaciZadatka, response) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    tmp = updatePodaciZadatka.datum_kreiranja.split(".");
...
exports.editZadatak = editZadatak;
